import Icon from './UI/assets/icons/downArrow.svg';
...
export const offersExample = [
	{
		...
		nombreOferta: 'EWL',
		tituloOferta: 'Oferta Madera',
		subtituloOferta: 'Operario de fábrica',
		resumenOferta:
			'Oferta para trabajar en la producción de elementos de madera en una planta de producción.',
		...
		imagenOferta: {
			url: '/UI/assets/img/defaultImage.png',
			name: 'workers',
